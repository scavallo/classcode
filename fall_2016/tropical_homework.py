...
# User settings
###########################
#imagedir = '/Users/scavallo/Documents/Work/Classes/METR5004/fall_2016/homework/images/'
...
p1, = ax1.plot(latitudes,f,'r',linewidth=3.0,label=r'$f_o$')
...
ax1.set_ylabel(r'Coriolis parameter ($f_o$)',fontsize=label_fontsize)
