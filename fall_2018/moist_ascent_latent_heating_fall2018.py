...
months2compare = [1,2] # [1,7] will compare January and July, [2,8] will compare February and August, etc.
...
infile2 = 'nnrp_t700_vs_lat_monthly_2017.dat'
...
for ii in range(1,5):
    ...
    # You will need to enter a few lines of code here to calculate the latent heating rates
...
p1b, = ax1.plot(xplot,sat_lapse_profile3,'b--',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[0] + ' 2017)')
p1c, = ax1.plot(xplot,sat_lapse_profile2,'r',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[1] + ')')
p1c, = ax1.plot(xplot,sat_lapse_profile4,'r--',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[1] + ')')
...
p2, = ax1.plot(xplot,fraction_profile3,'b--',linewidth=3.0,label='f (' + monthlabels[0] + ' 2017)')
p3, = ax1.plot(xplot,fraction_profile2,'r',linewidth=3.0,label='f (' + monthlabels[1] + ')' )
p4, = ax1.plot(xplot,fraction_profile4,'r--',linewidth=3.0,label='f (' + monthlabels[1] + ' 2017)' )
legend = ax1.legend(loc='upper left', shadow=True)
...
p2, = ax1.plot(xplot,dthetadt_perday_profile3,'b--',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[0] + ' 2017)')
p3, = ax1.plot(xplot,dthetadt_perday_profile2,'r',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[1] + ')')
p4, = ax1.plot(xplot,dthetadt_perday_profile4,'r--',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[1] + ' 2017)')
