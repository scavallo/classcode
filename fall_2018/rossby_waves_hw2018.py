...
umax = 35.0 # Approximate jet max in m s-1
...
latd_shift = -45.0 # Shift jet equatorward (negative) or poleward (positive) 
delta_latitude = 0.5

label_fontsize = 16
xlims = [0.,90.]
image_suffix = 'jetoption3_ubar35'
imagedir = ''
