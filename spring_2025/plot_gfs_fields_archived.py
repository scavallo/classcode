...
forecast_hour = "024"  # Forecast hour (000, 003, 006, etc.)
resolution = "0p25"  # Choose from 0p25, 0p50, 1p00 (higher resolution = larger file)
date = "20250313"  # YYYYMMDD format (update as needed)

# Custom options
overlay_windbarbs = False
plot_pressure_levels = [1000,500,900] #[main_level, upper_level, lower_level] 
...
save_dir = '/Users/scavallo/Documents/Work/Classes/METR5413/spring_2025/homework/data/'
#figname_prefix = f"gfs_700t_700ghgt_" 
figname_prefix = f"gfs_avort1000_"

plot_option = 8 # 0 to print file content to screen
                ...
                # 8 for plot_pressure_levels[0] mb vorticity fill and windbarbs
                # 9 for 700 mb vorticity fill and 1000:500 mb thickness
                # 10 for plot_pressure_levels[0] temperature fill and wind barbs
                # 11 for 700 mb temperature and geopotential height contours
...
if plot_option == 7:
    ax.set_title(f"{str(plot_pressure_levels[0])}-hPa temperature (GFS) (red) (2 degC interval)\n {analysis_time_title}\n  {valid_time_title} (Forecast hour {forecast_hour})", fontsize=14)
if plot_option == 8:
