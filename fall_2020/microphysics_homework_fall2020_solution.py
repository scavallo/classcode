...
Msol = ((14.007+(4*1.008))*2+32.06+(4*15.999))*10**(-3.) # ammonium sulfate 
...
p3, = ax1.plot(r,rh_total,'g',linewidth=2.5,label='Ammonium Sulfate')
p4, = ax1.plot(r,rh_total_NaCl,'g--',linewidth=2.5,label='Sodium Chloride')
