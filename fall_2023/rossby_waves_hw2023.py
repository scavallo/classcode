# rossby_waves_hw2023
#
# Simple model for showing basic zonally-averaged Rossby Wave statistics 
# given some user parameters, such as wavenumber, zonally-averaged background wind, etc.
#
# Steven Cavallo
# September 2023
###########################
...
#    umax = 20.0 # Maximum jet speed in m s-1
...
jet_lat = 45. # Center latitude of jet stream (degrees)
ubg = 20.0 # Background jet speed in m s-1
shape_param = 0.75 # thickness of jet in latitude space.  Lower numbers are thinner jets.
jet_option = 3 # 1 for no jet/ubar=0, 
               # 2 for constant jet/ubar=constant=ubg, 
               # 3 for zonally varying jet with ubg amp
               # 4 to determine jet/ubar by RW phase speed 
phasespeed_jet_option4 = 0.0 # Zonal phase speed of RWs if jet_option == 4
beta_plane = 'False'
constant_wavenumber = 'False' # 'True' : Wavenumber at every latitude is constant.  This implies the number of waves will vary with latitude
...
label_fontsize = 16
xlims = [0.,90.]
image_suffix = 'jetoption3_ubar20_jetlat45N'
#image_suffix = 'jetoption3_ubar20_jetlat45N_wavenumber3'
...
if ( (jet_option == 1) or (jet_option == 4)) :
    ...
    ubar = ubg*(1./np.cosh(2.0*np.pi*(Y-yc)/sigy))
...
# The line below sets the range of the y-axis limits
yticks = np.arange(-50,50.5,10)
