...
infile2 = 'nnrp_t700_vs_lat_monthly_2023.dat'
...
p1b, = ax1.plot(xplot,sat_lapse_profile3,'b--',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[0] + ' 2023)')
p1c, = ax1.plot(xplot,sat_lapse_profile2,'r',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[1] + ')')
p1c, = ax1.plot(xplot,sat_lapse_profile4,'r--',linewidth=3.0,label=r'$\Gamma_m$ (' + monthlabels[1] + '2023)')
...
p2, = ax1.plot(xplot,fraction_profile3,'b--',linewidth=3.0,label='f (' + monthlabels[0] + ' 2023)')
p3, = ax1.plot(xplot,fraction_profile2,'r',linewidth=3.0,label='f (' + monthlabels[1] + ')' )
p4, = ax1.plot(xplot,fraction_profile4,'r--',linewidth=3.0,label='f (' + monthlabels[1] + ' 2023)' )
legend = ax1.legend(loc='upper left', shadow=True)
...
p2, = ax1.plot(xplot,dthetadt_perday_profile3,'b--',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[0] + ' 2023)')
p3, = ax1.plot(xplot,dthetadt_perday_profile2,'r',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[1] + ')')
p4, = ax1.plot(xplot,dthetadt_perday_profile4,'r--',linewidth=3.0,label=r'$\theta$ LH rate (' + monthlabels[1] + ' 2023)')
